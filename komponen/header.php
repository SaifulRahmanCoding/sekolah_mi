<div id="main-ket-sekolah" class="py-1">
    <div class="container">
        <div class="ket-sekolah d-flex align-items-center">
            <span class="ps-lg-2 py-1"><i class="icon-phone"></i> &nbsp&nbsp</span><a href="tel:085258183685" class="me-4 text-decoration-none">085258183685</a>
            <span class="top-email"><i class="icon-envelope-open"></i> &nbsp&nbsp</span> <a href="mailto:nurul.hikmah.cdm@gmail.com" class="text-decoration-none">nurul.hikmah.cdm@gmail.com</a>
            <i class="icon-location-pin ms-auto me-2"></i>
            <p class="m-0">Desa Selolembu, Kec. Curahdami, Kab. Bondowoso</p>
        </div>
    </div>
</div>
